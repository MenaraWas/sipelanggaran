<div>
    ...
    <div class="custom-dashboard md3-animate-page">

        {{-- Top App Bar --}}
        <x-md3-top-bar :title="$appName" :subtitle="$instansiName" icon="dashboard" :user="$user" />
        ...
        <main class="cd-main">
            ...
            <section class="cd-bento">
                ...
                <div class="cd-card-main">
                    <div class="space-y-1">
                        <p class="text-l font-regular tracking-widest text-slate-400">PELANGGARAN MINGGU INI
                        </p>
                        <h2 class="text-2xl font-extrabold tracking-tight text-slate-900">{{ $weeklyTotal }}</h2>
